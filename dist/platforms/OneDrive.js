...
(function (OneDrive) {
    ...
    function getIds(url) {
        ...
        if (url.href) {
            ...
            if (url.href.indexOf('1drv.ms/v') > -1) {
                // return url.searchParams.get('v'); https://1drv.ms/v/s!AkXEMA-H1XcOhgSFiN5DziB0ICS2?e=5qLe8n
                var redirectedUrl = fetch('https://1drv.ms/v/s!AkXEMA-H1XcOhgUEW8iWLz7HqeX5?e=4GdvzD').url;
                parsedUrl = new url_1.URL(redirectedUrl);
            }
            else if (url.href.indexOf('onedrive.live.com')) {
                parsedUrl = url;
            }
            var cid = "0" + ((_a = parsedUrl === null || parsedUrl === void 0 ? void 0 : parsedUrl.searchParams.get('resid')) === null || _a === void 0 ? void 0 : _a.split('!')[0]);
